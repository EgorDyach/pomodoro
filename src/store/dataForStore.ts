...
export const CHANGE_NOTIFICATION_SOUND = "CHANGE_NOTIFICATION_SOUND";
export const SAVE_STATISTIC = "SAVE_STATISTIC";
export const CLEAR_DATA = "CLEAR_DATA";
export const CHANGE_SELECT_ACTIVE = "CHANGE_SELECT_ACTIVE";
export const CHANGE_DAY_IN_STATISTIC = 'CHANGE_DAY_IN_STATISTIC';